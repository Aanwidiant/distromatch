                ...
                <section className='space-y-8'>
                    ...
                    <Accordion type='single' collapsible className='mx-auto w-full max-w-4xl'>
                        <AccordionItem value='item-1'>
                            ...
                            <AccordionContent>
                                Distromatch adalah platform rekomendasi distro berbasis sistem
                                pendukung keputusan (SPK) yang transparan dan terukur.
                            </AccordionContent>
                        </AccordionItem>
                        ...
                        <AccordionItem value='item-6'>
                            <AccordionTrigger>
                                Apakah harus mendaftar dan masuk akun untuk menggunakan distromatch?
                            </AccordionTrigger>
                            <AccordionContent>
                                Ya, anda wajib mendaftar dan masuk akun Distromatch agar data hasil
                                dss yang anda dapatkan dapat disimpan dan diaudit juga.
                            </AccordionContent>
                        </AccordionItem>
                    </Accordion>
                </section>
