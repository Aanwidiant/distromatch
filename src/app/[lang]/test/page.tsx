...
const FORMULAS = {
    ...
    denseRank: String.raw`
      \begin{aligned}
      &\text{Misal hasil sorting: } \pi(1),\dots,\pi(n).\\
    ...
    return (
        <div className='space-y-4 text-lg'>
            <div className='flex flex-col gap-3'>
                ...
                <p>Rata-rata per dimensi (2 pertanyaan):</p>
            ...
            <p>Aturan urutan (descending) dengan tie-breaker total review:</p>
            <BlockMath math={FORMULAS.orderingRule} />

            <p>
                Dense rank dengan toleransi <InlineMath math='\varepsilon' />:
            </p>
