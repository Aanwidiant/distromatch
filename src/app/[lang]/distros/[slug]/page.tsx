...
export default async function DistroDetail({ params }: { params: Promise<{ slug: string }> }) {
    ...
    return (
        <main className='bg-background text-foreground grid min-h-screen flex-col gap-10 lg:grid-cols-3'>
            <div className='space-y-10 lg:col-span-2'>
                ...
                <div className='space-y-3'>
                    ...
                    <p className='text-foreground/80 leading-relaxed'>{distro.description}</p>
                </div>

                <div className='space-y-4'>
                    <h2 className='text-foreground text-lg font-semibold'>Rating Breakdown</h2>
            ...
            <div className='space-y-6'>
                ...
                {distro.docs_url?.length > 0 && (
                    <div className='space-y-2'>
                        <h3 className='text-foreground text-sm font-semibold'>Documentation</h3>
                ...
                <div className='space-y-2'>
                    <h3 className='text-foreground text-sm font-semibold'>Sources</h3>
